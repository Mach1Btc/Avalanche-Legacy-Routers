...
const Bottombar = () => {
    ...
    return (
        <div className='bottombar-container relative'>
            ...
            <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 flex items-center gap-1 sm:gap-2 pb-2 text-xxs sm:text-xs text-gray-600 dark:text-gray-200 whitespace-nowrap">
